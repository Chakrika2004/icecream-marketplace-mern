import flavor_image from "./flavor_image.png";
import fresh_fruits_image from "./fresh_fruits_image.png";
import syrup_image from "./syrup_image.png";
import main_banner_bg from "./main_banner_bg.png";
import main_banner_bg_sm from "./main_banner_bg_sm.png";
import bottom_banner_image from "./bottom_banner_image.png";
import IceCreamBucket_image from "./IceCreamBucket_image.png";
import sundae_image from "./sundae_image.png";
import diet_image from "./diet_image.png";
import star_icon from "./star_icon.png";
import star_dull_icon from "./star_dull_icon.png";
import logo from "./logo.png";
import cone_image from "./cone_image.png";
...
export const assets = {
  logo, search_icon, remove_icon, arrow_right_icon_colored, star_icon, star_dull_icon, cart_icon, nav_cart_icon, add_icon,
  refresh_icon, product_list_icon, order_icon, upload_area, profile_icon, menu_icon, delivery_truck_icon,
  leaf_icon, coin_icon, trust_icon, black_arrow_icon, white_arrow_icon, main_banner_bg, main_banner_bg_sm,
  bottom_banner_image, bottom_banner_image_sm, add_address_iamge, box_icon,
};
...
export const categories = [
  {
    ...
    path: "Flavors",
    image: flavor_image,
    bgColor: "#FFE4EC", // Strawberry Cream
  },
  {
    text: "Fruit Toppings",
    path: "Toppings",
    image: fresh_fruits_image,
    bgColor: "#E7FFF7", // Mint Frost
  },
  {
    text: "Cones",
    path: "cone",
    image: cone_image,
    bgColor: "#F9E8FF", // Mint Frost
  },
  {
    text: "Syrups & Sauces",
    path: "syrups",
    image: syrup_image,
    bgColor: "#FFF7E0", // Vanilla Latte
  },
  {
    text: "Ice Cream Bucket",
    path: "bucket",
    image: IceCreamBucket_image,
    bgColor: "#E8EDFF", // Blueberry Whip
  },
  {
    text: "Special Sundaes",
    path: "sundae",
    image: sundae_image,
    bgColor: "#FFEADB", // Peach Sorbet
  },
  {
    text: "Diet Options",
    path: "diet",
    image: diet_image,
    bgColor: "#F9E8FF", // Cotton Candy Mix
  },
];
