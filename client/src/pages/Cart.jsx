              ...
              <div>
                ...
                <div className="font-normal text-gray-500/70">
                  ...
                  <div className="flex items-center">
                    <p>Qty:</p>
                    <select onChange={e => updateCartItem(product._id, Number(e.target.value))} value={cartItems[String(product._id)]} className="outline-none">
                        {Array((cartItems[String(product._id)] || 1) > 9 ? cartItems[String(product._id)] : 9).fill("").map((_, index) => (
